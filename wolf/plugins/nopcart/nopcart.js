...
function ManageCart( ) {
   ...
   if ( iNumberOrdered == 0 ) {
      strOutput += "<TR><TD COLSPAN=6><div style="text-algin: center"><BR><B>Votre panier est vide</B><BR><BR></div></TD></TR>";
   }
...
// oweb : change quantity part 2 www.nopdesign.com/forum/viewtopic.php?f=5&t=1059
...
strOutput += "<TD ALIGN=CENTER><A style=\"text-decoration: none\" HREF=\"javascript: ChangeQuantity("+i+", (("+fields[1]+")-1));\"><b>&nbsp;-&nbsp;</b></a><INPUT TYPE=TEXT CLASS=checkoutinput NAME=Q SIZE=1 VALUE=\""+fields[1]+"\" onChange=\"ChangeQuantity("+i+", this.value);\"><A style=\"text-decoration: none\" HREF=\"javascript: ChangeQuantity("+i+", (("+fields[1]+")+1));\"><b>&nbsp;+&nbsp;</b></a></TD>";
} else {
strOutput += "<TD ALIGN=CENTER>" + fields[1] + "</TD>";
}

// oweb : change quantity part 2

         strOutput += "<TD>"+ moneyFormat(fields[2]) + MonetarySymbol + "</TD>";

         if ( DisplayShippingColumn ) {
            if ( parseFloat(fields[4]) > 0 )
               strOutput += "<TD>" + moneyFormat(fields[4]) + MonetarySymbol + "</TD>";
            else
               strOutput += "<TD>N/A</TD>";
         }
   ...
   if ( bDisplay ) {
      ...
      strOutput += "<TD COLSPAN=2><B>" + strTotal + MonetarySymbol + "</B></TD>";
      strOutput += "</TR>";

      if ( DisplayShippingRow ) {
         strOutput += "<TR><TD COLSPAN=4><B>"+strSHIP+"</B></TD>";
         strOutput += "<TD COLSPAN=2><B>" + strShipping + MonetarySymbol + "</B></TD>";
         strOutput += "</TR>";
      }
      ...
      if ( DisplayTaxRow || TaxByRegion ) {
         if ( TaxByRegion ) {
            ...
            strOutput += "<TR><TD COLSPAN=4><B>"+strTAX+"</B></TD>";
            strOutput += "<TD COLSPAN=2><B>" + strTax + MonetarySymbol + "</B></TD>";
            strOutput += "</TR>";
         }
      }
      ...
      if ( !TaxByRegion ) {
         ...
         strOutput += "<TD COLSPAN=2><B>" + moneyFormat((fTotal + fShipping + fTax)) + MonetarySymbol + "</B></TD>";
         strOutput += "</TR>";
      }
      strOutput += "</TABLE>";
...
// oweb insertion paypal	www.nopdesign.com/forum/viewtopic.php?f=10&t=2398
...
// ajout de tax
    strOutput += "<input type=hidden name=\"tax_" + strFooter + "\" value=\"" + strTax + "\">";
// ajout de tax
...
// oweb insertion paypal
   ...
   if ( bDisplay ) {
      ...
      strOutput += "<TD COLSPAN=2 ALIGN=RIGHT><B>" + strTotal + MonetarySymbol + "</B></TD>";
      strOutput += "</TR>";

      if ( DisplayShippingRow ) {
         strOutput += "<TR><TD COLSPAN=3><B>"+strSHIP+"</B></TD>";
         strOutput += "<TD COLSPAN=2 ALIGN=RIGHT><B>" + strShipping + MonetarySymbol + "</B></TD>";
         strOutput += "</TR>";
      }

      if ( DisplayTaxRow || TaxByRegion ) {
         strOutput += "<TR><TD COLSPAN=3><B>"+strTAX+"</B></TD>";
         strOutput += "<TD COLSPAN=2 ALIGN=RIGHT><B>" + strTax + MonetarySymbol + "</B></TD>";
         strOutput += "</TR>";
      }

      strOutput += "<TR><TD COLSPAN=3><B>"+strTOT+"</B></TD>";
      strOutput += "<TD COLSPAN=2 ALIGN=RIGHT><B>" + moneyFormat((fTotal + fShipping + fTax)) + MonetarySymbol + "</B></TD>";
      strOutput += "</TR>";
...
// oweb : refresh debut www.nopdesign.com/forum/viewtopic.php?f=5&t=2337
...
// oweb : mini cart debut www.nopdesign.com/forum/viewtopic.php?t=3333
